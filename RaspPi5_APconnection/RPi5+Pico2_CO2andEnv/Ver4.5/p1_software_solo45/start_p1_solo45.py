...
# -*- coding: utf-8 -*-
"""
Raspberry Pi 5 Unified Startup Script for Solo Version 4.5
Version: 4.5.0-solo
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/var/log/p1_startup_solo45.log"),
...
WEB_INTERFACE_SCRIPT = os.path.join(SCRIPT_DIR, "web_interface", "P1_app_simple45.py")
...
def main():
    """すべてのサービスを開始するメイン関数。"""
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 Unified Startup Script for Solo Version 4.5")

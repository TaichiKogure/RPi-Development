...
This is the main program for the Raspberry Pi Pico 2W (P2) that collects environmental data
...
# ===== ERROR HANDLING =====
ERROR_LOG_FILE = "/error_log_p2_solo44.txt"  # Error log file path
...
def initialize():
    ...
    try:
        ...
        try:
            from P2_wifi_client_solo44 import WiFiClient
            client = WiFiClient(
                ssid=WIFI_SSID,
        ...
        if client:
            ...
            try:
                from P2_wifi_client_solo44 import DataTransmitter
        ...
        try:
            from P2_watchdog_solo44 import Watchdog, handle_error

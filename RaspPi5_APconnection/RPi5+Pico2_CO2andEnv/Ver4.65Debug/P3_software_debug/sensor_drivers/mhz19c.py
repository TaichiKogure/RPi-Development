...
if __name__ == "__main__":
    try:
        print("=== MH-Z19C CO2 Sensor Test (Ver 4.18.0) ===")
        
        # Initialize sensor
        sensor = MHZ19C(uart_id=1, tx_pin=8, rx_pin=9, debug=True)
        print("MH-Z19C initialized")
        
        # Wait for sensor warmup
        print("Waiting for sensor warmup (30 seconds)...")
        for i in range(6):

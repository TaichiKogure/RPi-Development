...
class DataVisualizer:
    ...
    def get_historical_data(self, device_id, days=1):
        ...
        if device_id == "P2":
            ...
            full_dir = "/var/lib/raspap_solo/data/RawData_P4"
        elif device_id == "P5":
            full_dir = "/var/lib/raspap_solo/data/RawData_P5"
        else:  # P6
            full_dir = "/var/lib/raspap_solo/data/RawData_P6"
    ...
    def create_dashboard_graphs(self, days=1, show_p2=True, show_p3=True, show_p4=True, show_p5=True, show_p6=True):
        ...
        # Ver2.00zeroOne: Removed "co2" as we're disabling CO2 sensor functionality
        parameters = ['temperature', 'humidity', 'pressure', 'gas_resistance', 'absolute_humidity']  # 'co2' removed
        graphs = {}
        errors = {}
                ...
                if (data.P2) {
                    var p2Html = `
                        ...
                        <div class="row mt-2">
                            ...
                            <!-- Ver2.00zeroOne: CO2 display commented out as we're disabling CO2 sensor functionality
                            <div class="col-6 col-md-4">
                                <p>CO2</p>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <!-- Ver2.00zeroOne: CO2 card commented out as we're disabling CO2 sensor functionality
                        <div class="card mt-3">
                ...
                if (data && !data.error) {
                    var html = `
                        ...
                        <div class="row mt-2">
                            ...
                            <!-- Ver2.00zeroOne: CO2 reading display commented out as we're disabling CO2 sensor functionality
                            <div class="col-6">
                                <p>CO2</p>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data && data.errors) {
                    ...
                    // Ver2.00zeroOne: Removed "co2" as we're disabling CO2 sensor functionality
                    const parameters = ['temperature', 'humidity', 'absolute_humidity', 'pressure', 'gas_resistance'];
                ...
                if (data) {
                    ...
                    // Ver2.00zeroOne: CO2 graph loading code commented out as we're disabling CO2 sensor functionality
                    /*
                    // Load CO2 graph
                    if (data.co2) {
                        $('#loading-co2').hide();

        ...
        for device_id in ["P4", "P5", "P6"]:
            ...
            if not os.path.exists(fixed_file):
                with open(fixed_file, 'w', newline='') as f:
                    writer = csv.writer(f)
                    # Ver2.00zeroOne: Commented out "co2" column as we're disabling CO2 sensor functionality
                    writer.writerow(["timestamp", "device_id", "temperature", "humidity", "pressure", "gas_resistance", "", "absolute_humidity"])
    ...
    def _store_data(self, data):
        ...
        try:
            ...
            latest_data = {
                ...
                "co2": None,  # Set to None instead of removing to maintain data structure

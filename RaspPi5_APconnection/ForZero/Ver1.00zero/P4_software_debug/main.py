...
DEVICE_ID = "P4"                     # Device identifier
...
def initialize():
    ...
    try:
        ...
        print(f"=== Raspberry Pi Pico 2W Environmental Monitor Ver4.25 (P4) ===")
        print("Initializing...")
        ...
        from P4_wifi_client_debug import WiFiClient
        client = WiFiClient(
            ssid=WIFI_SSID,
        ...
        if not DEBUG_DISABLE_WATCHDOG:
            from P4_watchdog_debug import Watchdog

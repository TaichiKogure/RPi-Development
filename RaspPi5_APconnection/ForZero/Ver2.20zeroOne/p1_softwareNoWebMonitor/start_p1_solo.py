...
# -*- coding: utf-8 -*-
"""
Raspberry Pi 5 Unified Startup Script for Solo Version 2.0
Version: 2.0.0-solo
...
WEB_INTERFACE_SCRIPT = os.path.join(SCRIPT_DIR, "web_interface", "P1_app_simple.py")
...
DEFAULT_CONFIG = {
    ...
    "api_port": 5001,
    "monitor_port": 5002,
    "monitor_interval": 30,  # Increased from 5 to 30 seconds to reduce resource usage
    "interface": "wlan0",
...
def monitor_processes():
    ...
    while True:
        status_message = f"\n===== P1 Services Status (Ver 2.0) - {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')} =====\n"
...
Description=Raspberry Pi 5 Environmental Monitor Ver2.0
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 Unified Startup Script for Solo Version 2.0")
    ...
    print("\n===== Raspberry Pi 5 Environmental Monitor Ver2.0 =====")
    ...
    print("- BME680 sensors only (no CO2 sensors) in Ver2.0")
    print("====================================================\n")

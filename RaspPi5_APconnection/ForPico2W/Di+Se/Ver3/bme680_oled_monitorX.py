...
All information is displayed in a row-based layout with simplified formatting:
- Date and time are displayed as numbers only
- Sensor data is displayed without labels, showing only values with units
...
def get_time():
    ...
    # Return date and time as numbers only without formatting characters

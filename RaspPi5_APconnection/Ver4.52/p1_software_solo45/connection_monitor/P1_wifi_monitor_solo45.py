...
# -*- coding: utf-8 -*-
"""
Raspberry Pi 5 WiFi Connection Monitor for Solo Version 4.5
Version: 4.5.0-solo
...
Usage:
    python3 P1_wifi_monitor_solo45.py [--interval SECONDS] [--interface INTERFACE]
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/var/log/wifi_monitor_solo45.log"),
...
class WiFiMonitor:
    ...
    def _setup_api_routes(self):
        ...
        def get_device_data(device_id):
            ...
            if device_id not in ["P2", "P3"]:  # Ver4.5 accepts both P2 and P3
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 WiFi Connection Monitor - Solo Version 4.5")

...
class DataVisualizer:
    ...
    def create_dashboard_graphs(self, days=1, show_p2=True, show_p3=True):
        ...
        for param in parameters:
            graph_json = self.create_time_series_graph(param, days, show_p2, show_p3)
            if graph_json:
...
@app.route('/dashboard')
def dashboard():
    """Render the dashboard for both devices."""
...
def get_graphs():
    """API endpoint to get graphs for both devices."""
    days = request.args.get('days', default=1, type=int)
    show_p2 = request.args.get('show_p2', default='true').lower() == 'true'
    show_p3 = request.args.get('show_p3', default='true').lower() == 'true'

    graphs = visualizer.create_dashboard_graphs(days, show_p2, show_p3)

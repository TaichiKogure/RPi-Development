...
collected from a single P2 sensor node with BME680 sensor. It displays real-time data,
...
Usage:
    python3 app_solo.py [--port PORT] [--data-dir DIR]
"""
...
class DataVisualizer:
    ...
    def create_dashboard_graphs(self, device_id, days=1):
        ...
        parameters = ['temperature', 'humidity', 'pressure', 'gas_resistance']  # Removed co2_level
        graphs = {}
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary rounded">
            <div class="container-fluid">
                <a class="navbar-brand" href="/">Environmental Data Monitor - Solo</a>
        ...
        <footer class="mt-5 text-center text-muted">
            <p>Raspberry Pi 5 Environmental Data Monitor - Solo Version v1.0.0</p>
        </footer>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <p>Welcome to the Environmental Data Monitoring System - Solo Version. This interface allows you to view real-time and historical environmental data collected by the P2 sensor node with BME680 sensor.</p>
...
<script>
                ...
                if (data && !data.error) {
                    var html = `
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <p>Last Reading</p>
                                <p class="data-value">${data.timestamp}</p>
                            </div>
                        </div>
                    `;
    ...
    $(document).ready(function() {
        ...
        // Set up auto-refresh for current readings
        setInterval(updateCurrentReadings, {{ refresh_interval * 1000 }});
    });
</script>
{% endblock %}
"""

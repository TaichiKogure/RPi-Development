...
AP_SETUP_SCRIPT = os.path.join(SCRIPT_DIR, "ap_setup", "ap_setup_solo.py")
DATA_COLLECTOR_SCRIPT = os.path.join(SCRIPT_DIR, "data_collection", "data_collector_solo.py")
WEB_INTERFACE_SCRIPT = os.path.join(SCRIPT_DIR, "web_interface", "app_solo.py")
CONNECTION_MONITOR_SCRIPT = os.path.join(SCRIPT_DIR, "connection_monitor", "wifi_monitor_solo.py")

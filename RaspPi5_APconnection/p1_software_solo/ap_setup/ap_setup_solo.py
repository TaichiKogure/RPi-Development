...
# -*- coding: utf-8 -*-
"""
Raspberry Pi 5 Access Point Setup Script for Solo Version
Version: 2.0.0-solo

This script configures the Raspberry Pi 5 as a WiFi access point for a single P2 device
with BME680 sensor. It handles the installation and configuration of necessary packages,
...
Usage:
    sudo python3 ap_setup_solo.py [--configure | --enable | --disable | --status]
"""
...
def configure_dnsmasq(config):
    ...
    dnsmasq_config = f"""# dnsmasq configuration for Raspberry Pi 5 AP Solo
interface={config['ap_interface']}
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 Access Point Setup for Solo Version")

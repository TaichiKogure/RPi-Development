...
# -*- coding: utf-8 -*-
"""
Raspberry Pi Pico 2W Main Program for Environmental Monitoring - Solo Version 4.0
Version: 4.0.0-solo
...
SERVER_PORT = 5000
DEVICE_ID = "P3"  # Changed from P2 to P3
...
RESET_DELAY = 15  # seconds to wait before reset
...
def setup():
    ...
    try:
        print("\n=== Raspberry Pi Pico 2W Environmental Monitor Ver4.0 (P3) ===")
        print("Initializing...")

...
<body>
    <div class="container">
        ...
        <div class="card control-panel">
            <div class="card-header">グラフコントロール</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="refresh-interval">グラフ自動更新:</label>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <button id="refresh-graphs-btn" class="btn btn-primary">グラフを更新</button>
                        ...
                        <span id="graph-last-update" class="ms-3">最終更新: なし</span>
                    </div>
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <button id="refresh-btn" class="btn btn-primary">センサーデータを更新</button>
                <p id="last-update" class="mt-2">最終更新: なし</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function loadGraphs() {
            ...
            document.getElementById('graph-last-update').textContent = `最終更新: ${new Date().toLocaleTimeString()}`;
        ...
        function setupAutoRefresh() {
            ...
            // Set up sensor data refresh timer (10 seconds)
            sensorRefreshTimer = setInterval(updateSensorData, 10000);

            // Get graph refresh interval
            const interval = parseInt(document.getElementById('refresh-interval').value);

            // Set up new timer for graphs if interval > 0
            if (interval > 0) {
                graphRefreshTimer = setInterval(loadGraphs, interval * 1000);
            }
        }
...
def graph_info():
    ...
    <body>
        <div class="container mt-4">
            ...
            <h3>データソース</h3>
            <p>グラフは以下のCSVファイルからデータを読み込みます：</p>
            <ul>
                <li>P2: /var/lib(FromThonny)/raspap_solo/data/RawData_P2/P2_fixed.csv</li>
                <li>P3: /var/lib(FromThonny)/raspap_solo/data/RawData_P3/P3_fixed.csv</li>
            </ul>

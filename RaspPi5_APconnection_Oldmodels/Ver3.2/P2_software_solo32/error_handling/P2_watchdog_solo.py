# -*- coding: utf-8 -*-
"""
Watchdog and Error Handling for Raspberry Pi Pico 2W - Solo Version 3.2
Version: 3.2.0-solo
...
class ErrorHandler:
    ...
    def reset_device(self, delay=1):
        ...
        # Log the reset event
        self.logger.log_error("SYSTEM", "Device reset requested", {"reason": "Too many errors"})
...
if __name__ == "__main__":
    try:
        ...
        print("Testing watchdog and error handling (Solo Version 3.2)...")

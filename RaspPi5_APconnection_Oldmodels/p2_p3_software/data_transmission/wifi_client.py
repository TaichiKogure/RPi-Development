# -*- coding: utf-8 -*-
"""
WiFi Client for Raspberry Pi Pico 2W
Version: 2.0.0

This module provides functions to connect the Raspberry Pi Pico 2W to a WiFi network
and transmit sensor data to the Raspberry Pi 5 server.
...
Usage:
    import wifi_client
    client = wifi_client.WiFiClient(ssid="RaspberryPi5_AP", password="raspberry")
    client.connect()
...
class WiFiClient:
    ...
    def __init__(self, ssid="RaspberryPi5_AP", password="raspberry", 
        ...
        Args:
            ...
            device_id (str): Device identifier (P2 or P3)
        """
        self.ssid = ssid
            ...
            try:
                if name == "bme680":
                    ...
                    data.update({
                        ...
                        "gas_resistance": readings["gas_resistance"] if readings["gas_resistance"] is not None else 0
                    })
                elif name == "mhz19b":
                    co2 = sensor.read_co2()
                    if co2 is not None:
...
if __name__ == "__main__":
    try:
        ...
        # Initialize sensors
        bme680 = bme680_driver.BME680Sensor()
        mhz19b = mhz19b_driver.MHZ19BSensor()

        # Initialize WiFi client
        client = WiFiClient(device_id="P2")  # Change to P3 for the second Pico

        # Initialize data transmitter
        transmitter = DataTransmitter(client)
        transmitter.add_sensor("bme680", bme680)
        transmitter.add_sensor("mhz19b", mhz19b)

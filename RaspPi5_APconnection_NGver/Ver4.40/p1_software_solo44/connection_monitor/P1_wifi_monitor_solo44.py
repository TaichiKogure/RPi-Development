...
# -*- coding: utf-8 -*-
"""
Raspberry Pi 5 WiFi Connection Monitor for Solo Version 4.40
Version: 4.40.0-solo
...
class WiFiMonitor:
    ...
    def _setup_api_routes(self):
        ...
        def get_device_data(device_id):
            ...
            if device_id not in ["P2", "P3"]:  # Ver4.40 accepts both P2 and P3
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 WiFi Connection Monitor - Solo Version 4.40")

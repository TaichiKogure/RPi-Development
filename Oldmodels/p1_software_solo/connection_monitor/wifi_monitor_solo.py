...
# -*- coding: utf-8 -*-
"""
Raspberry Pi 5 WiFi Connection Monitor for Solo Version
Version: 1.0.0-solo

This module monitors the WiFi connection quality between the Raspberry Pi 5 (P1)
and the single Pico 2W device (P2) with BME680 sensor. It measures signal strength, 
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 WiFi Connection Monitor - Solo Version")

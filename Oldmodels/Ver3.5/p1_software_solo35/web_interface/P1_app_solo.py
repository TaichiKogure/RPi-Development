...
collected from a single P2 sensor node with BME680 and MH-Z19C sensors. It displays real-time data,
historical trends, and allows for data export.

Features:
- Real-time display of current sensor readings (including CO2)
- Time-series graphs of historical data with flexible Y-axis ranges
- Data export in CSV format
- Responsive design for mobile and desktop viewing
- Auto-refresh functionality
- Real-time signal strength display
- Fixed "LoadingGraph" issue
...
class DataVisualizer:
    ...
    def get_historical_data(self, device_id, days=1):
        ...
        if device_id != "P2":  # Solo version only accepts P2
            return None
    ...
    def create_time_series_graph(self, device_id, parameter, days=1):
        """Create a time series graph for the specified parameter with flexible Y-axis range."""
        ...
        try:
            ...
            # Customize layout with flexible Y-axis range
            fig.update_layout(
    ...
    def create_dashboard_graphs(self, device_id, days=1):
        """Create all graphs for the dashboard, including CO2."""
        parameters = ['temperature', 'humidity', 'pressure', 'gas_resistance', 'co2']
        graphs = {}
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary rounded">
            <div class="container-fluid">
                <a class="navbar-brand" href="/">Environmental Data Monitor - Solo Ver 3.5</a>
        ...
        <footer class="mt-5 text-center text-muted">
            <p>Raspberry Pi 5 Environmental Data Monitor - Solo Version v3.5.0</p>
        </footer>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <p>Welcome to the Environmental Data Monitoring System - Solo Version 3.5. This interface allows you to view real-time and historical environmental data collected by the P2 sensor node with BME680 and MH-Z19C sensors.</p>
                <p>Select the device dashboard below to view detailed information:</p>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <div class="card">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.P2 && data.P2.latest) {
                    ...
                    $('#connection-status').html('<div class="alert alert-warning">No connection data available</div>');
                }
            },
            error: function() {
                // Remove loading indicator and show error
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body" id="current-readings">
                                <div class="text-center" id="loading-readings">
                                    <div class="spinner-border text-primary" role="status">
                                        <span class="visually-hidden">Loading...</span>
                                    </div>
                                    <p>Loading data...</p>
                    ...
                    var html = `
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p class="mt-2">Ping: ${p2Data.ping_time ? p2Data.ping_time.toFixed(2) + ' ms' : 'N/A'}</p>
                            </div>
                        </div>
                    `;
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 Environmental Data Web Interface - Solo Version")

...
# -*- coding: utf-8 -*-
"""
Raspberry Pi 5 Environmental Data Collection Module for Solo Version 3.5
Version: 3.5.0-solo

This module receives environmental data from a single P2 Pico device with BME680 and MH-Z19C sensors via WiFi,
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Raspberry Pi 5 Environmental Data Collector for Solo Version 3.5")

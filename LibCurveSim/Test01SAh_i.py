#!/usr/bin/env python3
"""
battery_nmc_graphite_curves.py with Ah capacity display and smoothing (Interactive Version)
...
It also provides differential capacity analysis (dQ/dV) to help identify electrochemical reactions.
...
def main() -> None:
    ...
    print("=== Battery Charge-Discharge Curve Simulator with Ah Display (Interactive) ===")
    ...
    print("- Voltage vs Capacity (Ah) plot")
    print("- Differential Capacity Analysis (dQ/dV) plot")

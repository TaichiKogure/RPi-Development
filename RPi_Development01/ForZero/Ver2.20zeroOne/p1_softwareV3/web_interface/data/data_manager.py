...
class DataManager:
    ...
    def __init__(self, config):
        ...
        self.config = config
        self.last_data = {}
        self.data_cache = {"P1": None, "P2": None, "P3": None}
    ...
    def get_connection_status(self):
        ...
        try:
            ...
            # If API fails, return default status including local P1
            return {
                "P1": {"online": True, "signal_strength": None, "noise_level": None, "snr": None, "ping_time": None},
                "P2": {"online": False, "signal_strength": None, "noise_level": None, "snr": None, "ping_time": None},
                "P3": {"online": False, "signal_strength": None, "noise_level": None, "snr": None, "ping_time": None}
            }
        except Exception as e:

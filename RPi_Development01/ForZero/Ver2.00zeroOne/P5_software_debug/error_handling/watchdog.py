...
This module provides a simplified interface to the P5_watchdog_debug module.
It's intended to be imported by main.py on the Pico 2W.
"""

from P5_watchdog_debug import Watchdog, handle_error, log_error, sync_all_files, reset_device, safe_reset, init_error_log

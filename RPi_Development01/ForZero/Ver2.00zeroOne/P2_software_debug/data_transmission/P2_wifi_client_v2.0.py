    ...
    def collect_and_send_data(self):
        ...
        for name, sensor in self.sensors.items():
            try:
                ...
                # Use get_readings() method for all sensors to match test_simulation.py approach
                try:
                    ...
                    if name == "bme680":
                        try:
                            ...
                            self._debug_print(f"BME680 readings (fallback): Temp={sensor_data['temperature']}°C, "
                    ...
                    # Ver2.00zeroOne: Commented out MH-Z19C CO2 sensor fallback code as we're disabling CO2 sensor functionality
                    # Original MH-Z19C fallback code (commented out):
                    """
...
if __name__ == "__main__":
    try:
        ...
        # Ver2.00zeroOne: Commented out MH-Z19C import as we're disabling CO2 sensor functionality
        ...
        print("=== P2 WiFi Client Debug Test (Ver 4.25.0) ===")
        ...
        co2_sensor = None  # Set to None instead of initializing

        # Wait for CO2 sensor warmup
        # print("Waiting for CO2 sensor warmup...")
        # time.sleep(30)
        print("CO2 sensor disabled in Ver2.00zeroOne (BME680 only mode)")

        # Initialize WiFi client with debug level
        client = WiFiClient(device_id="P2", debug_level=DEBUG_DETAILED, debug_mode=True)

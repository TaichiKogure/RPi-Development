...
This module provides a simplified interface to the P5_wifi_client_debug module.
...
def connect_wifi(ssid="RaspberryPi5_AP_Solo", password="raspberry", device_id="P5"):
